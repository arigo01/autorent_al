...
$msg="Te Dhenat u Shtuan Me Sukses";
...
<head>
	...
	<title>AutoRentAL | Admin Modifiko te Dhenat e Makines</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Modifiko Makinen</h2>

						<div class="row">
							<div class="col-md-12">
								<div class="panel panel-default">
									<div class="panel-heading">Te Dhenat</div>
									<div class="panel-body">
<?php if($msg){?><div class="succWrap"><strong>SUKSES</strong>:<?php echo htmlentities($msg); ?> </div><?php } ?>
<?php 
$id=intval($_GET['id']);
...
<label class="col-sm-2 control-label">Emertimi i Makines<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="vehicletitle" class="form-control" value="<?php echo htmlentities($result->VehiclesTitle)?>" required>
</div>
<label class="col-sm-2 control-label">Zgjidh Brandin<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 control-label">Pershkrimi i Makines<span style="color:red">*</span></label>
<div class="col-sm-10">
...
<div class="form-group">
<label class="col-sm-2 control-label">Cmimi Per 1 Dite(Leke)<span style="color:red">*</span></label>
<div class="col-sm-4">
<input type="text" name="priceperday" class="form-control" value="<?php echo htmlentities($result->PricePerDay);?>" required>
</div>
<label class="col-sm-2 control-label">Zgjidh Llojin e Karburantit<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<option value="Diesel">Nafte</option>
<option value="CNG">GAZ</option>
</select>
</div>
</div>
...
<label class="col-sm-2 control-label">Nr. i Uleseve<span style="color:red">*</span></label>
<div class="col-sm-4">
...
<a href="ndrysho-imazh1.php?imgid=<?php echo htmlentities($result->id)?>">Ndrysho Img 1</a>
</div>
<div class="col-sm-4">
Image 2<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage2);?>" width="300" height="200" style="border:solid 1px #000">
<a href="ndrysho-imazh2.php?imgid=<?php echo htmlentities($result->id)?>">Ndrysho Img 2</a>
</div>
<div class="col-sm-4">
Image 3<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage3);?>" width="300" height="200" style="border:solid 1px #000">
<a href="ndrysho-imazh3.php?imgid=<?php echo htmlentities($result->id)?>">Ndrysho Img 3</a>
</div>
</div>
...
<a href="ndrysho-imazh4.php?imgid=<?php echo htmlentities($result->id)?>">Ndrysho Img 4</a>
</div>
<div class="col-sm-4">
Image 5
<?php if($result->Vimage5=="")
{
echo htmlentities("Imazhi Mungon");
} else {?>
<img src="img/vehicleimages/<?php echo htmlentities($result->Vimage5);?>" width="300" height="200" style="border:solid 1px #000">
<a href="ndrysho-imazh5.php?imgid=<?php echo htmlentities($result->id)?>">Ndrysho Img.5</a>
<?php } ?>
</div>
...
<div class="col-md-12">
<div class="panel panel-default">
<div class="panel-heading">Shtese</div>
<div class="panel-body">
...
<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-2" >
													...
													<button class="btn btn-primary" name="submit" type="submit" style="margin-top:4%">Ruaj Ndryshimet</button>
												</div>
											</div>
