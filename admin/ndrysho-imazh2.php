...
$msg="Imazhi u ngarkua me sukses";
...
<head>
	...
	<title>AutoRentAl | Ndrysho Imazhin 2</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imazhi 2 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Te dhenate e Imazhit 2</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imazhi 2 Aktual</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label"> Ngarko Imazhin 2<span style="color:red">*</span></label>
												<div class="col-sm-8">
