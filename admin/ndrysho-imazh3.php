...
$msg="Imazhi u ndryshua me sukses";
...
<head>
	...
	<title>AutoRentAl | Ndrysho imazhin 3</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imazhi 3 i Makines </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Imazhi 3 te dhenat</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imazhi 3 Aktual</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Zgjidh Imazhin 3 te Ri <span style="color:red">*</span></label>
												<div class="col-sm-8">
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="update" type="submit">Ngarko</button>
												</div>
											</div>
