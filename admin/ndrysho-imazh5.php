...
<head>
	...
	<title>AutoRentAl | Imazhi 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imazhi 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Te dhenat e imazhit 5</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imazhi 5 Aktual</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Ngarko imazhin 5 Te Ri<span style="color:red">*</span></label>
												<div class="col-sm-8">
