...
<head>
	...
	<title>AutoRentAl|Imazhi 4</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imazhi 4 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Te dhenat e Imazhit 4</div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imazhi 4 Aktual</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Ngarko Imazhin 4 te Ri<span style="color:red">*</span></label>
												<div class="col-sm-8">
