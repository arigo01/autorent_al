...
<head>
	...
	<title>AutoRentAl |Admin Menaxho Makinat   </title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Menaxho Makinat</h2>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">Detajet E makinave</div>
							...
							<?php if($error){?><div class="errorWrap"><strong>GABIM</strong>:<?php echo htmlentities($error); ?> </div><?php } 
								...
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
										<th>#</th>
											<th>Emertimi i Makines</th>
											<th>Brand </th>
											<th>Cmimi Per 1 Dite</th>
...
{				?>	
		...
		<td><a href="modifiko-makine.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
<a href="menaxho-makinat.php?del=<?php echo $result->id;?>" onclick="return confirm('Jeni i Sigurte qe Doni Ta Fshini?');"><i class="fa fa-close"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; }} ?>
