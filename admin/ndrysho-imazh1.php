			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Imazhi 1 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading"> Imazhi 1 </div>
...
<div class="form-group">
												<label class="col-sm-4 control-label">Imazhi 1 Aktual</label>
<?php 
$id=intval($_GET['imgid']);
...
<?php }}?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">Ngarko Imzah 1 te ri<span style="color:red">*</span></label>
												<div class="col-sm-8">
