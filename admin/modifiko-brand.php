...
$msg="Brandi u Modifikua Me Sukses";
...
<head>
	...
	<title>AutoRentAl | Admin Modifiko Brandin</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Modifiko Brandin</h2>
										...
										<?php }} ?>
											...
											<div class="form-group">
												<div class="col-sm-8 col-sm-offset-4">
													...
													<button class="btn btn-primary" name="submit" type="submit">Modiifiko</button>
												</div>
											</div>
