...
<title>AutoRentAl | Profili Im</title>
<!--Bootstrap -->
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Te dhenat</h5>
          <?php  
         if($msg){?><div class="succWrap"><strong>SUKSES</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
              <label class="control-label">Data e regjistrimit -</label>
             <?php echo htmlentities($result->RegDate);?>
            </div>
             <?php if($result->UpdationDate!=""){?>
            <div class="form-group">
              <label class="control-label">Data e dryshimit te fundit  -</label>
             <?php echo htmlentities($result->UpdationDate);?>
            </div>
            <?php } ?>
            <div class="form-group">
              <label class="control-label">Emri i plote</label>
            ...
            <div class="form-group">
              <label class="control-label">Nr. telefoni</label>
            ...
            <div class="form-group">
              <label class="control-label">Datelindja&nbsp;(dd/mm/yyyy)</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Ruaj Ndryshimet <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
